...
namespace LotOnline.Gz
{
    ...
    public class LotOnlineGzRequest : ATorgRequest
    {
        ...
        public LotOnlineGzRequest(string searchStr) : base(searchStr)
        {
            InitialiseParameters();
            MyParameters["SearchString"] = searchStr;
        }
        public override string Type => "LotOnline.Gz";
        ...
        {
            return new LotOnlineGzResponse(this);
        }
        ...
        protected override string myRawPostData()
        {
            ...
            {
                formatter.Serialize(sw, jsonReq);
                result += sw.ToString();
            }
            return result;
        }

        private string makeAnPost(string url = "https://gz.lot-online.ru/", string postData = "")
        {
